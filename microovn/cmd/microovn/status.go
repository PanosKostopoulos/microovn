...
func printCertsSummary(certificates *ovnCertificatePaths) {
	...
	printCertsSummaryHelper(certificates.Nb.Cert, "OVN Northbound Service")
	printCertsSummaryHelper(certificates.Sb.Cert, "OVN Southbound Service")
	printCertsSummaryHelper(certificates.Northd.Cert, "OVN Northd Service")
	printCertsSummaryHelper(certificates.Chassis.Cert, "OVN Chassis Service")
	printCertsSummaryHelper(certificates.Client.Cert, "Client")
}
